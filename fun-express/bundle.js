...
exports.ExpressAdapter = _ExpressAdapter3.default;
exports.createAzureFunctionHandler = _createAzureFunctionHandler2.default;
...
var OutgoingMessage = function () {
   ...
   */
  function OutgoingMessage(context) {
...
function createAzureFunctionHandler(requestListener) {
  var adapter = new _ExpressAdapter2.default(requestListener);
